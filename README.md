...
import cv2
image1 = cv2.imread('shin.jpg')
image2 = cv2.imread('kazama.webp')
image1.shape
image2.shape
...
![Screenshot 2024-09-14 110553](https://github.com/user-attachments/assets/402cbb45-14d2-48a8-b5a8-b666e409f1ea)
